...
fn main() {
    ...
    let data: [(i32, [&str; 7]); 10] = [
        (
            2016, "89786", "13296", "2.76", "80.05", "67", "2.2399", "20.86",
        ),
        (
            2017, "89922", "10284", "2.04", "86.4", "71.45", "2.3002", "19.68",
        ),
        (
            2018, "91750", "13907", "3.83", "86.5", "72.92", "2.3597", "19.00",
        ),
        (
            2019, "92865", "16063", "8.84", "113.2", "79.86", "2.4642", "17.74",
        ),
        (
            2020, "84681", "15737", "4.29", "112.62", "83.37", "2.7027", "16.04",
        ),
        (
            2021, "87470", "19457", "8.2", "128.9", "95", "2.7521", "19.04",
        ),
        (
            2022, "94780", "12326", "3.42", "131.68", "104.26", "2.8", "15.5",
        ),
        (
            2023, "93351", "13823", "4.24", "116.5", "95.6", "2.95", "13.5",
        ),
        (
            2024, "91720", "14488", "4.13", "99.6", "72.5", "3.0", "13.82",
        ),
        (
            2025, "89490", "11894", "3.56", "90.2", "69.9", "3.05", "12.74",
        ),
    ];
    s.years = data
        .iter()
